...
const InputSelect = ({ classAdd }) => {
  ...
  const handleChange = e => {
    setFormData({ ...formData, previousCarrier: e.target.value });
    e.target.value !== '' ? setValidationData({ ...validationData, previousCarrier: true }) : setValidationData({ ...validationData, previousCarrier: false })
  };
  return (
